    ...
    Protected Sub Page_Load() Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessage = If(message = "ChangePwdSuccess", "您的密碼已變更。", 
                    If(message = "SetPwdSuccess", "您的密碼已設定。", 
                    If(message = "RemoveLoginSuccess", "帳戶已移除。", 
                    If(message = "AddPhoneNumberSuccess", "已新增電話號碼", 
                    If(message = "RemovePhoneNumberSuccess", "已移除電話號碼", String.Empty)))))
