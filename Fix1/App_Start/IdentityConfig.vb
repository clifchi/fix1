...
Public Class ApplicationUserManager
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationUserManager), context As IOwinContext) As ApplicationUserManager
        ...
        ' 您可以在這裡寫下自己的提供者和外掛程式。
        manager.RegisterTwoFactorProvider("電話密碼", New PhoneNumberTokenProvider(Of ApplicationUser)() With {
          .MessageFormat = "您的安全密碼為 {0}"
        })
        manager.RegisterTwoFactorProvider("電子郵件密碼", New EmailTokenProvider(Of ApplicationUser)() With {
          .Subject = "安全密碼",
